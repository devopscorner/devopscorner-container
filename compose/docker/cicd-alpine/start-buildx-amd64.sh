...
build_alpine_315() {
    ...
    docker buildx build --push \
        ...
        -f $LINUX_ARCH_PATH/Dockerfile-Alpine-3.15-Ansible-Tower \
        -t $IMAGE:$TAG .
    echo ''
    ...
    for TAG in $TAGS; do
        ...
        docker buildx build --push \
            --platform $TARGETPLATFORM \
            -f $LINUX_ARCH_PATH/Dockerfile-Alpine-3.15-AWX \
            -t $IMAGE:$TAG .
        echo ''
    done
}
...
build_alpine_316() {
    ...
    docker buildx build --push \
        --platform $TARGETPLATFORM \
        -f $LINUX_ARCH_PATH/Dockerfile-Alpine-3.16-Ansible-Tower \
        -t $IMAGE:$TAG .
    echo ''
    ...
    for TAG in $TAGS; do
        ...
        docker buildx build --push \
            --platform $TARGETPLATFORM \
            -f $LINUX_ARCH_PATH/Dockerfile-Alpine-3.16-AWX \
            -t $IMAGE:$TAG .
        echo ''
    done
}
...
build_alpine_317() {
    ...
    docker buildx build --push \
        --platform $TARGETPLATFORM \
        -f $LINUX_ARCH_PATH/Dockerfile-Alpine-3.17-Ansible-Tower \
        -t $IMAGE:$TAG .
    echo ''
    ...
    for TAG in $TAGS; do
        ...
        docker buildx build --push \
            --platform $TARGETPLATFORM \
            -f $LINUX_ARCH_PATH/Dockerfile-Alpine-3.17-AWX \
            -t $IMAGE:$TAG .
        echo ''
    done
}
