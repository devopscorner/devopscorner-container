...
main() {
  # docker_build [AWS_ACCOUNT] Dockerfile devopscorner/nifi [alpine|ubuntu] [version|latest|tags] [custom-tags]
  # docker_build [AWS_ACCOUNT] Dockerfile devopscorner/nifi-registry [alpine|ubuntu] [version|latest|tags] [custom-tags]
...
### How to Execute ###
# ./ecr-build.sh [AWS_ACCOUNT] Dockerfile [ECR_PATH] [alpine|ubuntu] [version|latest|tags] [custom-tags]
